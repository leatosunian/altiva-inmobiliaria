    ...
    <>
      <div className={`${styles.container} `}>
        <motion.div
          ...
          className="bg-gradient-to-r from-black overflow-hidden to-transparent flex items-center px-5 justify-center w-full h-full"
        >
          <Card
          ...
          >
            <div className="flex flex-col gap-5 sm:gap-8 text-white">
              <motion.div
