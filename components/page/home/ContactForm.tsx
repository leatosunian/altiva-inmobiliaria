...
const ContactForm = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center w-full gap-8 px-40 mx-auto my-7 h-fit md:gap-24 md:flex-row md:my-40 md:px-4 lg:px-24 py-auto 2xl:px-72">
