    ...
    return (
        ...
        >
            ...
            <div className="w-[95vw] max-w-lg md:max-w-4xl mx-auto">
                <div className="px-4 py-3 border rounded-full bg-white/10 backdrop-blur-md border-white/20 md:px-6 md:py-2">
                            ...
                            {navigation.map((item) =>
                                item.href.startsWith("/") ? (
                                    <Link
                                        key={item.name}
                                        href={item.href}
                                        className="font-medium transition-all duration-200 text-white/80 hover:text-white hover:scale-105"
                                    >
                                        {item.name}
                                    </Link>
                                ) : (
            ...
            <div className="relative md:hidden">
                ...
                >
                    <div className="p-4 border shadow-2xl bg-white/10 backdrop-blur-md border-white/20 rounded-2xl">
