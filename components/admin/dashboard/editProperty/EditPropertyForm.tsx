...
import { formSchema } from "@/app/schemas/editPropertyForm";
...
const EditPropertyForm = ({ uuid }: { uuid: string }) => {
  ...
  useEffect(() => {
    if (propertyData) {
      ...
      if (propertyData!.bathrooms) form.setValue("bathrooms", propertyData!.bathrooms.toString());

      form.setValue("businessType", propertyData!.businessType.toString());
      if (propertyData!.garageCarsQuantity) form.setValue("garageCarsQuantity", propertyData!.garageCarsQuantity.toString());
      ...
      if (propertyData!.metersSquare) form.setValue("metersSquare", propertyData!.metersSquare.toString());
      form.setValue("description", propertyData!.description);
      if (propertyData!.coveredMetersSquare) form.setValue("coveredMetersSquare", propertyData!.coveredMetersSquare.toString());
      if (propertyData!.expensas) form.setValue("expensas", propertyData!.expensas.toString());
      if (propertyData!.antiquity) form.setValue("antiquity", propertyData!.antiquity.toString());
      if (propertyData!.floors) form.setValue("floors", propertyData!.floors.toString());
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleEdit)} className="">
            <div className="flex flex-col w-full gap-10 md:flex-row">
              <Card className="flex flex-col w-full gap-4 p-4 md:w-1/2">
              ...
              <Card className="hidden w-1/2 p-4 md:block">
            ...
            <Card className="p-4 mt-6 ">
              <span className="mb-2 text-lg font-semibold md:text-xl">Datos del Inmueble</span>
              <Separator className="my-2" />

              <div className="grid grid-cols-1 gap-4 mt-4 mb-2 md:gap-8 md:grid-cols-4 2xl:grid-cols-6 ">
                {/* floors input */}
                <FormField
                  control={form.control}
                  name="floors"
